...
urlpatterns = [
    ...
    url(r'^phonenum/', include('phoneNum.urls')),
    url(r'^(\d+)/$',views.index),
    url(r'^$',views.index),
    url(r'^hz/$',views.hz),
    url(r'^export_link/',views.export_excel),
    ...
    url(r'^uploadpro/$', views.uploadpro),
    url(r'^sjcx1/$',views.tghsj1),
    url(r'^tghsj_ajax/$',views.tghsj_ajax),
